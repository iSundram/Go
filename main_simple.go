...
func main() {
	if len(os.Args) < 2 {
		fmt.Println("Usage: go-decompiler-simple <binary-file>")
		fmt.Println("Example: go-decompiler-simple ./directadmin")
		os.Exit(1)
	}
	...
	outputFile := filepath.Join(srcDir, baseName+"_comprehensive.go")
